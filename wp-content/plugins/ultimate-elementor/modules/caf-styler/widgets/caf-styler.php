	...
	protected function register_radio_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .uael-caf-form .caldera-grid .checkbox input[type=checkbox], {{WRAPPER}} .uael-caf-form .caldera-grid .radio input[type=radio] + span:before' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .uael-caldera-form-wrapper .uael-caf-form .caldera-grid .radio input[type=radio] + span:before' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .uael-caldera-form-wrapper .uael-caf-form .caldera-grid .checkbox input[type=checkbox]' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .uael-caldera-form-wrapper .uael-caf-form .caldera-grid form .checkbox input[type=checkbox]:after' => 'color: {{VALUE}};',
					'{{WRAPPER}} .uael-caldera-form-wrapper .uael-caf-form .caldera-grid  form .radio input[type=radio]:checked + span:before' => 'background-color: {{VALUE}}; box-shadow:inset 0px 0px 0px 4px {{caf_radio_check_bgcolor.VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .uael-caldera-form-wrapper .uael-caf-form .checkbox label, {{WRAPPER}} .uael-caldera-form-wrapper .uael-caf-form .radio label' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .uael-caldera-form-wrapper .uael-caf-form .caldera-grid form .checkbox input[type=checkbox], {{WRAPPER}} .uael-caldera-form-wrapper .uael-caf-form .caldera-grid form .radio input[type=radio] + span:before' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .uael-caf-form .caldera-grid .checkbox input[type=checkbox], {{WRAPPER}} .uael-caf-form .caldera-grid .radio input[type=radio] + span:before' => 'border-width: {{SIZE}}{{UNIT}}; border-style: solid;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .uael-caldera-form-wrapper .uael-caf-form .caldera-grid form .checkbox input[type=checkbox]' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'default'    => [
					'top'    => '0',
					'bottom' => '0',
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'scheme'   => Scheme_Typography::TYPOGRAPHY_3,
					'selector' => '{{WRAPPER}} .uael-caf-form input:not([type=submit]):not([type=button]):not([type=image]), {{WRAPPER}} .uael-caf-form .form-group textarea, {{WRAPPER}} .uael-caf-form .form-group select,{{WRAPPER}} .uael-caf-form .form-group .ccselect2-choice, {{WRAPPER}} .uael-caf-form .checkbox label, {{WRAPPER}} .uael-caf-form .radio label, {{WRAPPER}} .uael-caf-form .uael-caf-select-custom',
				]
			);
