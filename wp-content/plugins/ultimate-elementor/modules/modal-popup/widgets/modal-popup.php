...
class Modal_Popup extends Common_Widget {
	...
	public function get_embed_params() {
		...
		if ( 'youtube' == $settings['content_type'] ) {
			$youtube_options = [ 'rel', 'controls', 'showinfo', 'mute', 'modestbranding' ];
			...
			foreach ( $youtube_options as $option ) {
				...
				if ( 'rel' == $option ) {
					if ( 'yes' == $settings['youtube_related_videos'] ) {
						$params[ $option ] = 0;
					}
					continue;
				}
				...
				if ( 'showinfo' == $option ) {
					if ( 'yes' == $settings['youtube_title_controls'] ) {
						$params[ $option ] = 0;
					}
					continue;
				}
