...
;(function($, window, document, undefined) {
	...
	$win.on('load', function() {
		...
		$('.booked-calendar-wrap').on('click', '.page-right, .page-left, .monthName a', function(e) {
			...
			savingState(true,thisCalendarWrap);
            console.log('labas is next click js');
            console.log(booked_js_vars.ajax_url);
			$.ajax({
				url: booked_js_vars.ajax_url,
				type: 'post',
				data: args,
		...
		$('body').on('click','.booked-form input#submit-request-appointment',function(e){
			...
			var customerType        = $('#newAppointmentForm input[name=customer_type]').val(),
				...
				guest_phone      	= $('#newAppointmentForm input[name=guest_phone]').val(),
				guest_comment      	= $('#newAppointmentForm input[name=guest_comment]').val(),
		...
		var SubmitRequestAppointment = {
			...
			baseFields: 	[ 'guest_name', 'guest_phone', 'guest_comment', 'guest_surname','guest_email','action', 'customer_type', 'user_id' ],
			...
			_reloadCalendarTable: function() {
				...
				$.ajax({
					...
					success: function( html ) {
						...
						close_booked_modal();
						$("#ff045ee-overlay").click();
						$('a[data-modal="495abf9"]').click();
						$('tr.entryBlock').removeClass('booked-loading');
