...
if(!class_exists('Booked_AJAX')) {
	class Booked_AJAX extends Calendar_Public_Display {
		...
		public function booked_calendar_month(){
			if (isset($_POST['gotoMonth'])):
				...
				$this->booked_fe_calendar($year,$month,$calendar_id,$force_default);
		...
		public function booked_calendar_date(){
			...
			if (isset($_POST['date'])):
				...
				$calendar_id = (isset($_POST['calendar_id']) ? $_POST['calendar_id'] : false);
				$this->booked_fe_calendar_date_content($_POST['date'],$calendar_id);
		...
		public function booked_new_appointment_form(){
            if ( apply_filters( 'booked_show_new_appointment_form', true ) ):
				include(plugin_dir_path( __FILE__ ). 'front/appointment-form.php');
			endif;
			wp_die();
		}
		...
		public function booked_add_appt(){
            ...
            $appointmentData = [
				...
				'guest_surname' => isset($_POST['guest_surname']) ? $_POST['guest_surname'] : '',
            ...
            $can_add_appt = $this->add_apointment_api($appointmentData);
