...
<div class="booked-form booked-scrollable">
	...
	if ( $has_appts ) {
        include(plugin_dir_path( __FILE__ ). 'appointment-form/form.php');
	}
...
<p class="booked-title-bar"><small><?php echo ( $new_appointment_default == 'draft' ? esc_html__('Rezervavimo pateikimas','booked') : esc_html__('Rezervavimo pateikimas','booked') ); ?></small></p>
