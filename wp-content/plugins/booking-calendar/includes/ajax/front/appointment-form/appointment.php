...
?><div class="booked-appointment-details" data-appt-key="<?php echo $appointment_key; ?>"><?php
	...
	if ( $appt_timeslot == $all_day_text ):
		?><p class="appointment-info"><i class="booked-icon booked-icon-calendar"></i>&nbsp;&nbsp;&nbsp;<?php echo sprintf( esc_html__( '%s laikas %s','booked' ), $appt_timeslot, $appt_date_name ); ?></p><?php
	else:
		?><p class="appointment-info"><i class="booked-icon booked-icon-calendar"></i>&nbsp;&nbsp;&nbsp;<?php echo sprintf( esc_html__( '%s laikas %s','booked' ), $appt_date_name, $appt_timeslot ); ?></p><?php
	endif;
