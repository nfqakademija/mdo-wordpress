	...
	class Astra_Nav_Menu_Above_Header_Typography extends Astra_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				...
				// Option: Above Megamenu Divider.
				array(
					'name'     => ASTRA_THEME_SETTINGS . '[above-header-megamenu-heading-typo-divider]',
				...
				array(
					'name'      => ASTRA_THEME_SETTINGS . '[above-header-megamenu-heading-font-family]',
					'type'      => 'control',
					'control'   => 'ast-font',
				...
				array(
					'name'              => ASTRA_THEME_SETTINGS . '[above-header-megamenu-heading-font-weight]',
					'type'              => 'control',
					'control'           => 'ast-font',
					...
					'section'           => 'section-above-header-typo',
					'connect'           => ASTRA_THEME_SETTINGS . '[above-header-megamenu-heading-font-family]',
					'required'          => array(
						'conditions' => array(
							array( ASTRA_THEME_SETTINGS . '[above-header-section-1]', '==', 'menu' ),
							array( ASTRA_THEME_SETTINGS . '[above-header-section-2]', '==', 'menu' ),
				...
				array(
					'name'      => ASTRA_THEME_SETTINGS . '[above-header-megamenu-heading-text-transform]',
					'type'      => 'control',
					'control'   => 'select',
					'section'   => 'section-above-header-typo',
				...
				array(
					'name'        => ASTRA_THEME_SETTINGS . '[above-header-megamenu-heading-font-size]',
					'section'     => 'section-above-header-typo',
					'transport'   => 'postMessage',
